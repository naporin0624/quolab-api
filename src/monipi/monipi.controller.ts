...
export class MonipiController {
  constructor(private readonly createMonipiService: CreateMonipiService, private readonly labService: LabService, private readonly monipiService: MonipiService, private readonly userService: UserService){}
