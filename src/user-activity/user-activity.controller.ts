...
export class UserActivityController {
  constructor(private readonly postUserActivityDataService: PostUserActivityDataService) {}
  ...
  postUserActivityData(
    ...
    return this.postUserActivityDataService.postUserActivityData(userActivityDataDto, user)
  }
